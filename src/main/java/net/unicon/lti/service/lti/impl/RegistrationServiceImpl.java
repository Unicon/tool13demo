...
public class RegistrationServiceImpl implements RegistrationService {
    ...
    public ToolRegistrationDTO generateToolConfiguration(PlatformRegistrationDTO platformConfiguration, String altDomain) {
        ...
        if (StringUtils.isNotBlank(altDomain)) {
            altDomainLocalUrl = DomainUtils.insertDomain(altDomain, localUrl, TextConstants.LTI_PREFIX);
        }
        ...
        if (StringUtils.isNotBlank(altDomain)) {
            toolConfigurationDTO.setDomain(DomainUtils.insertDomain(altDomain, domainUrl, TextConstants.HOME_PREFIX));
        } else {
