...
public interface RegistrationService {
    ...
    ToolConfigurationACKDTO callDynamicRegistration(String token, ToolRegistrationDTO toolRegistrationDTO, String endpoint) throws ConnectionException;

    void saveNewPlatformDeployment(ToolConfigurationACKDTO answer, PlatformRegistrationDTO platformRegistrationDTO) throws RegistrationException;
}
